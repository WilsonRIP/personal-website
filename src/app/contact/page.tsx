        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="rounded-xl overflow-hidden shadow-lg dark:bg-gray-800/70 bg-white/80 backdrop-blur-md border border-gray-200 dark:border-gray-700 p-6">
              <h2 className="text-2xl font-bold mb-6 text-teal-500">Contact Info</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium dark:text-gray-400 text-gray-500">Email</p>
                      <p className="dark:text-gray-300 text-gray-700">contact@example.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium dark:text-gray-400 text-gray-500">Location</p>
                      <p className="dark:text-gray-300 text-gray-700">United States</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Social Media Links */}
              <div className="mt-8">
                <h3 className="text-lg font-semibold mb-4 dark:text-gray-300 text-gray-700">Connect with me</h3>
          ...
          >
            <div className="rounded-xl overflow-hidden shadow-lg dark:bg-gray-800/70 bg-white/80 backdrop-blur-md border border-gray-200 dark:border-gray-700 p-6">
              <h2 className="text-2xl font-bold mb-6 text-teal-500">Send a Message</h2>
