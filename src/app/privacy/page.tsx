    ...
    >
      <div className="w-full max-w-4xl space-y-8">
        ...
        >
          <motion.section
            variants={fadeIn}
            className="rounded-xl overflow-hidden shadow-lg dark:bg-gray-800/70 bg-white/80 backdrop-blur-md border border-gray-200 dark:border-gray-700 p-8"
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                Thank you for visiting {WEBSITE_NAME}. This Privacy Policy
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <p>
                Depending on the activity, we may collect the following
                information:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Name</li>
              ...
              <h3 className="text-xl font-semibold mt-6 text-gray-700 dark:text-gray-300">
                Usage Data
              </h3>
              <p>
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                out newsletters or analyzing how our website is used. These
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                ...
                use, alteration, and disclosure. However, we cannot guarantee
                that unauthorized third parties will never be able to defeat
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  The right to request that we correct or update incorrect
