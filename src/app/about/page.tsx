...
export default function AboutPage() {
  ...
  const skills = [
    ...
    {
      category: "Tools",
      items: ["Git", "Docker", "VS Code", "GitHub Actions"],
    },
    {
      category: "Design",
            ...
            <div className="sticky top-24 rounded-xl overflow-hidden shadow-lg dark:bg-gray-800/70 bg-white/80 backdrop-blur-md border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                ...
                <p className="text-sm dark:text-gray-300 text-gray-700 mb-4">
                  ...
                  for creating intuitive and engaging web experiences.
                </p>
                <div className="space-y-2">
                  <p className="flex items-center text-sm">
                    <span className="w-24 font-medium dark:text-gray-400 text-gray-500">
                      Location:
                    </span>
            ...
            <LazyLoad>
              ...
              >
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <p>
                    Hello! I&apos;m a passionate software developer with a
                    strong focus on building intuitive and performant web
                    applications. My journey in technology began when I first
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Led development of web applications, mentored junior
                      developers, and implemented modern development workflows.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      ...
                      across various industries using React, Node.js, and other
                      modern technologies.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      ...
                      technologies. Graduated with honors.
                    </p>
                  </div>
                </div>
              </motion.div>
